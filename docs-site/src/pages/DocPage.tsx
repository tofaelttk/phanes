...
export default function DocPage() {
  ...
  return (
    <div className="flex flex-1 w-full min-w-0 justify-center px-4 sm:px-5 lg:px-6 py-8 lg:py-10">
      <div className="flex w-full max-w-[min(85rem,calc(100vw-1.5rem))] items-start justify-center gap-6 lg:gap-7 min-w-0">
        <div className="min-w-0 w-full max-w-[40rem]">
          <header className="mb-10">
            <h1
              id={titleId}
              className="group flex flex-wrap items-baseline gap-x-2 gap-y-1 text-3xl sm:text-[2rem] font-semibold tracking-tight text-[var(--color-text)] leading-tight scroll-mt-28"
            >
        ...
        <aside className="hidden lg:flex w-[260px] shrink-0 flex-col border-l border-[var(--color-border)] bg-[var(--color-bg)] py-8 pl-5 pr-3 sticky top-14 self-start max-h-[calc(100vh-3.5rem)] min-h-0 overflow-hidden">
