...
export function Footer() {
  return (
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-bg-subtle)] mt-auto">
      <div className="mx-auto max-w-[1800px] px-4 lg:px-6 py-8 flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between text-[13px] text-[var(--color-text-secondary)]">
